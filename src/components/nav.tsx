            ...
            <div>
                ...
                <div className="h-[232px] w-[250px] flex justify-center items-center">
                    <div className=" w-[202px] h-[185px] font-normal leading-[19.59px] text-[16px] ">
                        <Link to="/main" className="w-[202px] h-[40px] text-[#94a3b8] font-[16px] tracking-[0.5px] flex justify-start items-center  "><img src={home} className="mr-[16px]" />{t('nav1')}</Link>
                        <Link to="/main/tasks" className="w-[202px] h-[40px] text-[#94a3b8] font-[16px] tracking-[0.5px] flex justify-start items-center mt-[8px]"><img src={checkbox} className="mr-[16px]" />{t('nav2')}</Link>
                        <Link to="/main/goals" className="w-[202px] h-[40px] text-[#94a3b8] font-[16px] tracking-[0.5px] flex justify-start items-center mt-[8px]"><img src={cup} className="mr-[16px]" />{t('nav3')}</Link>
                        <Link to="/main/members" className="w-[202px] h-[40px] text-[#94a3b8] font-[16px] tracking-[0.5px] flex justify-start items-center mt-[8px]"><img src={user} className="mr-[16px]" />{t('nav4')}</Link>
                    </div>
                </div>
                ...
                <div className="h-[511px] w-[249px]  flex justify-center items-start">
                    <div className="h-[224px] w-[226px]  mt-[26px] flex items-center flex-col">
                        <div className="flex h-[24px] w-[202px] justify-between items-start">
                            <h1 className="text-[12px] mt-[2px] tracking-[1px] font-bold leading-[15px] text-[#94a3b8]">{t('nav5')}</h1>
                ...
                <div className="h-[100px] w-[250px] flex justify-center items-center">
                    <div className="h-[36px] w-[202px] mb-[2px] ml-[-1px] bg-[#F8FAFC] rounded-[1000px] flex justify-center items-center">
                        <div className="h-[28px] w-[97px] flex justify-center items-center">
                            ...
                            <h1 className="text-[12px] text-[#94A3B8] font-medium tracking-[0.4px] leading-[14.32px]">{t('nav6')}</h1>
                        </div>
                        <div className="h-[28px] w-[97px] flex justify-center items-center bg-white rounded-[1000px] shadow-theme">
                            ...
                            <h1 className="text-[12px] text-[#1E293B] font-extrabold tracking-[0.2px] leading-[14.32px]">{t('nav7')}</h1>
                        </div>
                    </div>
                </div>
            </div>
